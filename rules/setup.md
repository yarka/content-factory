...
## Шаг 0: Анализ существующего канала (если есть)

Спроси:
> "Скинь ссылку на свой канал или аккаунт — я посмотрю что уже есть."

Если дал ссылку на публичный Telegram-канал:
- Сделай WebFetch на `https://t.me/s/{username}`
- Прочитай посты, составь первое впечатление:
  - Основные темы
  - Тон и голос
  - Что заходит (судя по контенту)
- Поделись наблюдениями коротко: "Вижу что ты пишешь про X, Y, Z. Тон — такой-то."

Если канала нет — пропусти этот шаг.
